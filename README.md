...
from [`src/index.js`](../../Desktop/dra-web-elm/src/index.js).

If you had previously enabled service workers in your production deployment and
have decided that you would like to disable them for all your existing users,
you can swap out the call to `serviceWorkerRegistration.register()` in
[`src/index.js`](../../Desktop/dra-web-elm/src/index.js) with a call to `serviceWorkerRegistration.unregister()`.
...
1. Service workers are [not currently supported](https://jakearchibald.github.io/isserviceworkerready/) in all web browsers. Service worker registration [won't be attempted](../../Desktop/dra-web-elm/src/registerServiceWorker.js) on browsers that lack support.
